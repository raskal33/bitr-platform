...
The Platform is a decentralized prediction gaming platform built on Monad Testnet blockchain technology. By using our services, you acknowledge that you understand the risks associated with blockchain technology and cryptocurrency transactions.`
    },
    {
      id: "eligibility",
...
• Maintain an active gaming profile with MON token activity
...
All games use Monad Testnet tokens (MON) and BITR tokens for participation and rewards.`
    },
    {
...
**Testnet Environment**: Bitredict operates on Monad Testnet. All tokens have no real-world value and are for testing purposes only.
...
• Requires active MON token gaming activity
...
We will respond to inquiries within 48 hours during business days.`
  ...
  summary: {
    ...
    points: [
      ...
      "Bitredict operates on Monad Testnet - all tokens are for testing only",
      "BITR faucet requires 2+ Oddyssey predictions and MON activity",
